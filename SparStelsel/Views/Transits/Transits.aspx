             ...
             <%
                 ...
                 Html.Telerik().Grid<Transit>()
                    ...
                    .Columns(columns =>
                    {
                        ...
                        columns.Bound(model => model.TransitID);
                    ...
                    {
                        dataBinding.Ajax()
                                   .Select("_ListTransits", "Transits")
                                   .Insert("_InsertTransits", "Transits")
                                   .Update("_UpdateTransits", "Transits")
                                   .Delete("_RemoveTransits", "Transits");
                    })
