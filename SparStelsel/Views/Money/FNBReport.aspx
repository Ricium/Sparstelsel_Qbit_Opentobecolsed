<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<CashierFNBReport>" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    ...
                                                    %>
                                                    <tr>
                                                        <td style="width: 75px; padding-right: 5px">
                                                            <%: Html.DisplayFor(c => el.RefNo) %>
                                                        </td>
                                                        <td>R</td>
                                                        <td style="text-align: right; width: 75px">
                                            ...
                                            <td style="vertical-align: top">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td>R</td>
                                                        <td style="text-align: right; width: 75px; border-bottom: double; border-top: solid"><%: Html.DisplayFor(m => m.ReferenceTotal) %></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                            ...
                                            <td style="vertical-align: top">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td>R</td>
                                                        <td style="text-align: right; width: 75px; border-bottom: double; border-top: solid"><%: Html.DisplayFor(m => m.RefundTotal) %></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
