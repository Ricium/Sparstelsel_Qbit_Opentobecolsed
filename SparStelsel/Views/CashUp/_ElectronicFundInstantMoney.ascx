        ...
        <tr>
            <td>
             <%
                 ...
                 Html.Telerik().Grid<CashMovementInstantMoney>()
                      .Name("CashMovementInstantMoney")
                      ...
                      {
                          dataBinding.Ajax()
                                     .Select("_ListCashMovementInstantMoney", "CashUp")
                                     .Insert("_InsertCashMovementInstantMoney", "CashUp")
                                     .Update("_UpdateCashMovementInstantMoney", "CashUp")
                                     .Delete("_RemoveCashMovementInstantMoney", "CashUp");
                      })
        ...
        <tr>
            <td>
             <%
                 ...
                 Html.Telerik().Grid<CashMovementInstantMoney>()
                      .Name("CashMovementInstantMoneyC")
                      .DataKeys(keys => keys.Add(s => s.CashMovementID))
                      ...
                      {
                          dataBinding.Ajax()
                                     .Select("_ListCashMovementInstantMoneyC", "CashUp")
                                     .Insert("_InsertCashMovementInstantMoneyC", "CashUp")
                                     .Update("_UpdateCashMovementInstantMoneyC", "CashUp")
                                     .Delete("_RemoveCashMovementInstantMoneyC", "CashUp");
                      })
