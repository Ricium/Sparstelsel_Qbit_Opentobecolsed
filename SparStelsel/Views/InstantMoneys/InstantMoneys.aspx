            ...
            <td>
             <%
                 ...
                 Html.Telerik().Grid<InstantMoney>()
                    ...
                    .ToolBar(commands => commands.Insert().ImageHtmlAttributes(new { style = "margin-left:0" }).ButtonType(GridButtonType.ImageAndText).Text("Add InstantMoneys"))
                    .Columns(columns =>
                    {
                    ...
                    {
                        dataBinding.Ajax()
                                   .Select("_ListInstantMoneys", "InstantMoney")
                                   .Insert("_InsertInstantMoneys", "InstantMoney")
                                   .Update("_UpdateInstantMoneys", "InstantMoney")
                                   .Delete("_RemoveInstantMoneys", "InstantMoney");
                    })
