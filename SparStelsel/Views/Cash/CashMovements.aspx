             ...
             <%
                 ...
                 Html.Telerik().Grid<CashMovement>()
                    ...
                    .Columns(columns =>
                    {
                        ...
                        columns.Bound(model => model.CashMovementID);
                    ...
                    {
                        dataBinding.Ajax()
                                   .Select("_ListCashMovements", "Cash")
                                   .Insert("_InsertCashMovements", "Cash")
                                   .Update("_UpdateCashMovements", "Cash")
                                   .Delete("_RemoveCashMovements", "Cash");
                    })
